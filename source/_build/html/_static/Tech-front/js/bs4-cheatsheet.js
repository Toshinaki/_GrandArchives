$(function(){
    ...
    var elementClipboard = new ClipboardJS('.item-copy-link', {
    ...
    var showboxClipboard = new ClipboardJS('#showbox-copy', {
        text: function() {
            return $(currentItemData).children(".rendered").html();
        }
    });

    var classClipboard = new ClipboardJS('.class-copy-link');
